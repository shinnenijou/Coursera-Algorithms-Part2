...
public class BaseballElimination {
    ...
    public String toString() {
        ...
        for (String team : teams.keys()) {
            ...
            sb.append(String.format("%20s", team));
            sb.append(String.format("%10d", wins[i]));
            sb.append(String.format("%10d", losses[i]));
            sb.append(String.format("%10d", remaining[i]));

            for (int j = 0; j < teams.size(); ++j) {
                sb.append(String.format("%4d", schedule[i][j]));
            }
            sb.append("\n");
        }
